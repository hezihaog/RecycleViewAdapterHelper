...
public class DashboardProvider extends BaseViewProvider<Dashboard> {
    public DashboardProvider(@NonNull Context context) {
        super(context, R.layout.item_main_dashboard);
    }
     ...
     */
    @Override
    public void onBindView(RecyclerViewHolder holder, Dashboard bean) {
        holder.setText(R.id.content, bean.getText());
    }
}
